...
private void handleList() {
    ...
    //         this.client = new FileClient(address, port);
    //         this.isConnected = true;
    //         System.out.println("Connecté au serveur " + address + ":" + port);
...
private void handleConnect(String args) {
    try {
        ...
        FileClient testClient = new FileClient(address, port); // Crée une instance temporaire pour tester la connexion
...
private void showHelp() {
    ...
    System.out.println("  upload <chemin>          - Uploader un fichier ou dossier");
    System.out.println("  download <nom> <dest>    - Télécharger un fichier ou dossier");
